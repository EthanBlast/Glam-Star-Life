...
<?php else : ?>
	...
	<?php if ('open' == $post->comment_status) : ?>
		...
		<p class="nocomments"><?php _e('There are no comments yet.  Be the first and leave a response!', 'headway'); ?></p>
		
	<?php else : ?>

		<?php if(is_single()){ ?>
			<p class="nocomments"><?php _e('Sorry, comments are closed for this post.', 'headway'); ?></p>
		<?php } ?>
...
?>
	...
	<span id="comment-form" class="heading"><?php comment_form_title(); ?></span>

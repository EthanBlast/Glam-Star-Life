...
<div id="mass-font-change-box" class="floaty-box floaty-box-close floaty-box-center">
	...
	<p class="float-left clear-left select-container">
		<label><?php _e('Titles', 'headway'); ?></label>			
		<select id="mass-font-select-titles" class="mass-font-select">
	...
	<p class="float-left clear-left select-container">
		...
		<select id="mass-font-select-content" class="mass-font-select">
			<?php headway_font_options(); ?>
		</select>
...
<div id="ie-box" class="floaty-box">
	...
	<div class="floaty-box-content">
		...
		<p>Feeling risky?  <a href="<?php echo get_bloginfo('url'); ?>/?visual-editor=true" onclick="jQuery.cookie('headway-visual-editor-ie', 1); window.location='<?php echo get_bloginfo('url') ?>/?visual-editor=true'; return false;" style="font-size:11px;margin-left:5px;" class="button">Continue on your on parole.</a></p>
	</div>
</div>
<?php
}
...
<div id="wizard-box" class="floaty-box floaty-box-close<?php echo $wizard_class; ?>"<?php echo $wizard_display; ?>>
	...
	<div class="floaty-box-content">
		...
		<div id="wizard-panel-4" class="wizard-panel wizard-panel-hidden">
			...
			<p class="float-left clear-left select-container">
				<label><?php _e('Titles', 'headway'); ?></label>			
				<select id="wizard-fonts-titles" class="font-family">
					<?php headway_font_options(); ?>
				</select>
				<small><?php _e('Header title, post/page titles, widget headings, post meta', 'headway'); ?></small>
			</p>
			...
			<p class="float-left clear-left select-container">
				<label><?php _e('Content', 'headway'); ?></label>
				<select id="wizard-fonts-content" class="font-family">
					<?php headway_font_options(); ?>
				</select>
				<small><?php _e('Post/page content, hyperlinks, tagline', 'headway'); ?></small>
			</p>

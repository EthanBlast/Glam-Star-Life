...
add_action('init', 'headway_visual_editor');
...
function headway_layout_chooser_slider_form_action(){
	if(isset($_POST['switch-layout']) && $_POST['switch-layout'] == true){
		if(isset($_POST['layout-page']) && $_POST['layout-page'] == true){
			...
			header('Location: '.get_permalink($_POST['layout-page']).'/'.$sign.'visual-editor=true'.$safe_mode);
		}
		elseif(isset($_POST['layout-system-page']) && $_POST['layout-system-page'] == true){
			...
			if($_POST['layout-system-page'] == 'four04') $system_page_link = get_bloginfo('url').'/'.rand(10000, 50000);
			...
			if($_POST['layout-system-page'] == 'index'){ 
				...
				{
					$system_page_link = get_bloginfo('url');
				}
			}
			...
			if($_POST['layout-system-page'] == 'author'){
				...
				$system_page_link = get_bloginfo('url').'/?author='.$author_id;
			}
			
			if($_POST['layout-system-page'] == 'search') $system_page_link = get_bloginfo('url').'/?s=%20';			

				...
				<div class="featured-post clearfix" id="featured-post-<?php the_id(); ?>">
					...
					<?php echo $post_left[get_the_id()]?>
					  ...
					  <div class="featured-post-container"<?php echo $container_width?>>
						<?php headway_post_meta('title', 'above', true, array('left' => $leaf['options']['featured-meta-title-above-left'])); ?>
						...
						<?php headway_post_meta('title', 'below', true, array('left' => $leaf['options']['featured-meta-title-below-left'])); ?>
						...
						<?php headway_post_meta('content', 'below', true, array('left' => $leaf['options']['featured-meta-content-below-left'])); ?>
					  </div>

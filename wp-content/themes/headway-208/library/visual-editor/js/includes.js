  ...
  scrollbarPaper: function() {
    this.each(function(i) {
      ...
      if (ratio < 1) {
        ...
        paper.show().addClass('scrollbarpaper-visible');
		...
		//Clay: Added minus 42 for bottom part of scroller
        drag.height(dragHeight - 42);
        ...
        $this.unbind();
        paper.hide().removeClass('scrollbarpaper-visible');

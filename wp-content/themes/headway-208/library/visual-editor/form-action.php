...
$nonce = $_POST['headway-ve-nonce'];
$truncate = (isset($_POST['truncate'])) ? $_POST['truncate'] : false;
...
if(isset($_POST['column-order']) && $_POST['column-order'] != 'unserialized'){		
	$new_columns_order = explode('&', str_replace('column-', '', preg_replace("/(-)(page)(\[\])(=)([a-z0-9_])/is", '', $_POST['column-order'])));

...
if(isset($headway_admin_success) && $headway_admin_success === true)
	echo '<div class="success"><span>Configuration Updated!</span> <a href="'.home_url().'">View Site &raquo;</a></div>';
?>
	...
	<div id="tabs">
		...
		<div id="general-options" class="tab">
			...
			<table class="form-table">
				<tr>
					...
					<td><input type="text" class="regular-text" value="<?php echo htmlspecialchars(stripslashes(headway_get_option('headway-username'))) ?>" id="headway-username" name="headway-username" />
					</td>
				</tr>
				...
				<tr class="no-border">
					...
					<td><input type="password" class="regular-text" value="<?php echo htmlspecialchars(stripslashes(headway_get_option('headway-password'))) ?>" id="headway-password" name="headway-password"/>
					</td>
				</tr>
			</table>
			...
			<table class="form-table">
				...
				<tr valign="top">
					...
					<td><input type="text" class="regular-text" value="<?php echo htmlspecialchars(stripslashes(headway_get_option('favicon'))) ?>" id="favicon" name="favicon"/>
				...
				<tr valign="top" class="no-border">
					...
					<td><input type="text" class="regular-text" value="<?php echo htmlspecialchars(stripslashes(headway_get_option('affiliate-link'))) ?>" id="affiliate-link" name="affiliate-link"/>
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><input type="text" class="regular-text" value="<?php echo htmlspecialchars(stripslashes(headway_get_option('feed-url'))) ?>" id="feed-url" name="feed-url"/>
			...
			<table class="form-table">
				<tr valign="top">
					<th scope="row"><label for="hide-admin-menu-version">Menu Version Number</label></th>
					
					<td> 
						<fieldset>
							<legend class="hidden">Hide Version</legend>
							<label for="hide-admin-menu-version">
								<?php headway_build_checkbox('hide-admin-menu-version') ?>
								Hide Version
							</label>
						</fieldset>
						
						<span class="description">By default, Headway will show the current version number in the admin menu.  If you would like to not show it and just display "Headway", use this checkbox to hide it.</span>
					</td>
				</tr>
				
				<tr valign="top" class="no-border">
					<th scope="row"><label for="disable-version-checks">Version Checks</label></th>
					
					<td> 
						<fieldset>
							<legend class="hidden">Version Checks</legend>
							<label for="disable-version-checks">
								<?php headway_build_checkbox('disable-version-checks') ?>
								Disable Automatic Version Checks
							</label>
						</fieldset>
						
						<span class="description">Headway will automatically display a bar at the top of the admin panel when there's an available update.  To hide those messages, use this checkbox.</span>
					</td>
				</tr>
			</table>			
		</div>
		...
		<div id="comments" class="tab">
			<h2>Comments</h2>
				...
				<table class="form-table">
					<?php echo headway_build_admin_input('check', 'comments', 'hide-comment-dates', 'Comment Dates', 'Hide Comment Dates', headway_get_option('hide-comment-dates'), false, false, 'By default, the comment dates will be shown under the comment author.  Use this to hide the comment dates.'); ?>
				</table>
				...
				<table class="form-table">
					...
					<?php echo headway_build_admin_input('text', 'comments', 'avatar-size', 'Avatar Size', true, headway_get_option('avatar-size'), false, true, 'Enter the square dimension of the avatars.  The default is 48px.  If you want it to be 36 pixels by 36 pixels, you\'d simply type 36.'); ?>
					
					<?php echo headway_build_admin_input('text', 'comments', 'default-avatar', 'Default Avatar URL', false, headway_get_option('default-avatar'), true, false, 'Type the URL to the default URL (could be your logo or anything).  This will replace the traditional grey mystery man.'); ?>
				</table>
		...
		<div id="headway-seo" class="tab">
			...
			<?php if(defined('WPSEO_VERSION')){ ?>
				<p class="notice">Headway has detected that you are running Yoast's WordPress SEO plugin.  In order to avoid conflict, the Headway SEO settings are disabled.  If you wish to, you can continue using the plugin or you can deactivate it and use Headway's SEO features.</p>
			<?php } elseif(class_exists('All_in_One_SEO_Pack')){ ?>
		...
		<div id="scripts-options" class="tab">
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><textarea rows="10" class="regular-text" id="" name="header-scripts"><?php echo htmlspecialchars(stripslashes(headway_get_option('header-scripts'))) ?></textarea>
				...
				<tr valign="top" class="no-border">
					...
					<td><textarea rows="10" class="regular-text" id="" name="footer-scripts"><?php echo htmlspecialchars(stripslashes(headway_get_option('footer-scripts'))) ?></textarea>

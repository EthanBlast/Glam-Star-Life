...
<?php
} elseif(isset($_FILES['import']) && $_FILES['import'] && !isset($_POST['update-headway'])){		
			...
			<table class="form-table">
				<tr class="no-border">
					...
					<td>
						...
						<input type="submit" onclick="window.open('<?php echo home_url() ?>/?visual-editor=true&amp;safe-mode=true'); return false;" value="Enter Visual Editor &mdash; Safe Mode" name="enter-safe-mode" id="enter-safe-mode" class="button-secondary" tabindex="305" />

...
define('HEADWAYGENERATOR', HEADWAYLIBRARY.'/generator');
...
require_once HEADWAYGENERATOR.'/functions.php';
...
require_once HEADWAYCORE.'/capabilities.php';

 ...
 */
?>
<div id="slidedeck_preview_window" class="preview-window">
	<div style="margin:0 auto;padding:0;width:<?php echo intval( $preview_w ); ?>px;position:relative;overflow:hidden;">
	...
	<div id="slidedeck_preview_window_form">
		...
		<label>
		    <?php if( ( (boolean) $slidedeck['dynamic'] == true ) || ( $skin['meta']['Skin Type'] == "fixed" ) ): ?>
                Width:
            <?php else: ?>
                Dimensions:
            <?php endif; ?>

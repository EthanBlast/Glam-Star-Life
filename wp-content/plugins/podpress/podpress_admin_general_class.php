...
*/
	class podPressAdmin_class extends podPress_class
	{
		...
		function settings_general_edit() {
			...
			//~ $querystring = "SELECT meta_value FROM ".$wpdb->postmeta." WHERE meta_key = 'podPressMedia' AND post_id=117";
			//~ printphpnotices_var_dump($querystring);
			//~ $result = $wpdb->get_results($querystring, ARRAY_A);
			//~ printphpnotices_var_dump(unserialize($result[0]['meta_value']));
			
			//~ $querystring = "SELECT DISTINCT post_id FROM ".$wpdb->postmeta." WHERE meta_key = 'podPressMedia' AND INSTR(meta_value, 'premium_content')";
			//~ printphpnotices_var_dump($querystring);
			...
			echo '					</select>'."\n";
			echo '				</td>'."\n";
			echo '				<td valign="top">'.__('Part of the Post where the podPress content (Player, and links) will go. Default is at the end.', 'podpress').'</td>'."\n";
			echo '			</tr> '."\n";
			echo '			<tr>'."\n";
			...
			echo '					</select>'."\n";
			echo '				</td>'."\n";
			echo '				<td valign="top">'.__('Allow users to make use of the web players for your content / Popup Only - Only the Popup Player is available and it is not possible to use the player in the posts. / Inline Only - The Popup player is not available and it is only possible to use the player in the posts.', 'podpress').'</td>'."\n";
			echo '			</tr> '."\n";
			echo '			<tr>'."\n";
			...
			echo '					</select>'."\n";
			echo '				</td>'."\n";
			echo '				<td valign="top">'.__('The image that shows up before links for the media file.', 'podpress').'</td>'."\n";
			echo '			</tr> '."\n";
			echo '			<tr>'."\n";
			...
			echo '					</select>'."\n";
			echo '				</td>'."\n";
			echo '				<td valign="top">'.__('Show the Hide Player/Play Now link', 'podpress').'</td>'."\n";
			echo '			</tr> '."\n";
			...
			echo '					</select>'."\n";
			echo '				</td>'."\n";
			echo '				<td valign="top">'.__('Allow users to download the media files directly from the website.', 'podpress').'</td>'."\n";
			echo '			</tr> '."\n";
			...
			echo '					</select>'."\n";
			echo '				</td>'."\n";
			echo '				<td valign="top">'.__('If disabled, users can still download using the icon link.', 'podpress').'</td>'."\n";
			echo '			</tr> '."\n";
			...
			echo '					</select>'."\n";
			echo '				</td>'."\n";
			echo '				<td valign="top">'.__('Display download stats for each media file for everyone to see at the end of the podPress line. This will cause a performance hit of 2 extra SQL queries per post being displayed. Disable this feature if your site is slowing down when podpress is enabled.', 'podpress').'</td>'."\n";
			echo '			</tr> '."\n";
			...
			echo '					</select>'."\n";
			echo '				</td>'."\n";
			echo '				<td valign="top">'.__('Display the duration for each media file.', 'podpress').'</td>'."\n";
			echo '			</tr> '."\n";
			...
			echo '					</select>'."\n";
			echo '				</td>'."\n";
			echo '				<td valign="top">'.__('This defines that the player and the download links will always be visible on the short version of a post.', 'podpress').'</td>'."\n";
			echo '			</tr> '."\n";
			echo '		</table>'."\n";
			echo '	</fieldset>'."\n";

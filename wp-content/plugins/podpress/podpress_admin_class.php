...
*/
	class podPressAdmin_class extends podPress_class
	{
		...
		function edit_category_form($input) {
			...
			echo '						'.__('Only use Category Casting if you understand what this feature is and you need it.', 'podpress').'<br/> <!-- (TODO: explain this feature better) -->'."\n";
			echo '					</div>'."\n";
			...
			echo '				</td>'."\n";
			echo '				<td width="50%">';
			echo '					<label for="blogdescriptionChoice"><strong>'.__('Description (Tagline)', 'podpress').'</strong></label>:'."\n";
			echo '					<br/>';

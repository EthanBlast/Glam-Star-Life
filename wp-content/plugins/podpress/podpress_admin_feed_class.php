...
class podPressAdmin_class extends podPress_class
	{
		...
		function settings_feed_edit() {
			...
			*/
			...
			echo '					</select>'."\n";
			echo '					<br/>'.__('Setting to indicate (in iTunes) whether or not your podcast contains explicit language or content which is not suitable for non-adult persons.', 'podpress')."\n";
			...
			echo '		<a name="podpressfeeds" id="podpressfeeds"></a><h3>'.__('podPress Feeds', 'podpress').'</h3>'."\n";

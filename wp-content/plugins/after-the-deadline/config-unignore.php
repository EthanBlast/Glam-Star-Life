...
if (navigator.appName == 'Microsoft Internet Explorer')
   ...
   <input type="hidden" name="AtD_ignored_phrases" id="AtD_ignored_phrases" value="<?php echo esc_attr( $ignores ); ?>">
          ...
          <p style="font-weight: bold"><?php _e('Ignored Phrases', 'after-the-deadline'); ?></font>
     
          <p><?php _e('Identify words and phrases to ignore while proofreading your posts and pages:', 'after-the-deadline'); ?></p>

          <p><input type="text" id="AtD_add_ignore" name="AtD_add_ignore"> <input type="button" value="<?php _e('Add', 'after-the-deadline'); ?>" onclick="javascript:atd_ignore()"></p>
